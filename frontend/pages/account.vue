<template>
      ...
      <main class="content">
        ...
        <section class="profile-content">
          <div class="profile-text">
            <p class="breadcrumb">Home / My Account</p>
            <div class="welcome">Welcome! <span class="highlight">Puja Barman</span></div>
          </div>
  
          <!-- Updated Red Box Section -->
  ...
  /* Top Header */
  .top-header {
    background-color: #ff8a8a; /* Top header bar */
    height: 20px;
  }
  ...
  /* Form Container */
  .form-container {
    width: 80%; /* Increased size of the box */
    background-color: #d32f2f; /* Updated red color to match */
