  ...
  <div class="container mx-auto px-4 py-6">
    ...
    <section>
      ...
      <div class="grid grid-cols-4 gap-6">
        <div v-for="(product, index) in bestSellingProducts" :key="index" class="text-center border p-4 rounded-lg relative">
          <!-- Heart and Eye Icons -->
    ...
    <section class="mt-10">
      ...
      <div class="grid grid-cols-4 gap-6">
        <div v-for="(product, index) in products" :key="index" class="text-center border p-4 rounded-lg relative">
          ...
          <!-- Special Badges -->
          <span v-if="product.new" class="absolute top-2 left-2 bg-green-500 text-white px-2 py-1 rounded text-xs">NEW</span>
